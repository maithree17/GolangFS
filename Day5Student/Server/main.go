...
var mongoDbName string = "sms_app_db"
...
// USN Student for Collection "students"
type Student struct {
...
func connectDB() {
	...
	if studentCollection==nil{
		log.Fatal("MongoDB Collection Error:", "Big Problem")
		return
	}
...
func updateStudent(c *gin.Context) {
	...
	oldStudent.USN = jbodyStudent.USN
	oldStudent.Branch = jbodyStudent.Branch
